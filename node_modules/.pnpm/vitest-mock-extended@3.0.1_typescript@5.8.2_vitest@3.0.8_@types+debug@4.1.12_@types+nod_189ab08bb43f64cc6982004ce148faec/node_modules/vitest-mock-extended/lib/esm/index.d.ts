...
export { type CalledWithMock, CaptorMatcher, type DeepMockProxy, type GlobalConfig, Matcher, type MatcherCreator, type MatcherFn, type MatcherLike, type MatchersOrLiterals, type MockOpts, type MockProxy, VitestMockExtended, any, anyArray, anyBoolean, anyFunction, anyMap, anyNumber, anyObject, anySet, anyString, anySymbol, arrayIncludes, calledWithFn, captor, isA, mapHas, matches, mock, mockClear, mockDeep, mockFn, mockReset, notEmpty, notNull, notUndefined, objectContainsKey, objectContainsValue, setHas, stub };
